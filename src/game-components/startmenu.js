...
export class StartMenu {
    ...
    draw(p5) {
        ...
        p5.text('ASTEROIDES', 0, -200)
        p5.textSize(32);
        p5.text(`LEVEL: ${this.level}`, 0, 0);
        p5.text(`Controls: ARROWS or ASWD & ENTER or SPACE for shooting`, 0, 100);
        p5.text(`PRESS SPACE TO START`, 0, 200);
